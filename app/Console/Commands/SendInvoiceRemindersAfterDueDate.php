...
class SendInvoiceRemindersAfterDueDate extends Command
{
    protected $signature = 'app:send-invoice-reminders-after-due-date {--user_id=0} {--limit=0}';
    protected $description = 'Send invoice reminders after due date using query builder';
    ...
    public function handle()
    {
        ...
        if ($user_id != 0) {
            $query = DB::table('users as u')
                ...
                ->where('s.everyday_reminder_after_due_day', '=', 'Y')
                ...
                foreach ($overdue as $invoice) {
                    if (!empty($invoice->email)) {
                        ...
                        try {
                            ...
                            $mail->Body    =  view('emails.invoice_reminder_after_due_date', compact('invoice'));
