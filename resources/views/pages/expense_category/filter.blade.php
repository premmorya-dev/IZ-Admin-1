                ...
                <div class="accordion-body">
                    <div class="accordion-body">
                        <form action="" method="GET" class="row g-3 mb-4">
                            ...
                            <div class="col-md-3 ">
                                <label for="expense_category_name" class="form-label">Expense Category Name</label>
                                <input type="text" name="expense_category_name" value="{{ request('expense_category_name') }}" id="expense_category_name" placeholder="expense Category Name" class="form-control">
                            </div>
                            ...
                            <div class="col-12 text-end">
                                ...
                                <a href="{{ route('expense.category.list') }}" class="btn btn-secondary btn-sm"><i class="bi bi-eraser-fill"></i> Reset</a>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#filter-btn').on('click', function(e) {
            ...
            addParam('expense_category_name');

          



            location = '{{url("/")}}' + '/expense/category/list?filters=true' + url;
