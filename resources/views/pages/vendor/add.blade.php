<form action="{{ route('vendor.store') }}" id="add-vendor-form" method="POST" enctype="multipart/form-data">
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-footer bg-light text-end rounded-bottom-4">
            <button type="submit" class="btn btn-success px-4 save-vendor w-100">
...
<script>
    document.querySelector('.save-vendor').addEventListener('click', function(e) {
        e.preventDefault();
