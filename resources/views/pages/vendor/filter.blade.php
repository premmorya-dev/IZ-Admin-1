                    ...
                    <div class="accordion-body">
                        <form action="" method="GET" class="row g-3 mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="vendor_name" name="vendor_name" value="{{ request('vendor_name') }}" placeholder="Type to search vendor..." autocomplete="off">
                                <div id="vendorList" class="list-group" style="position: absolute; z-index: 1000;"></div>
                            </div>
                            ...
                            <div class="col-12 text-end">
                                ...
                                <a href="{{ route('vendor.list') }}" class="btn btn-secondary btn-sm"><i class="bi bi-eraser-fill"></i> Reset</a>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#filter-btn').on('click', function(e) {
            ...
            location = '{{url("/")}}' + '/vendor/list?filters=true' + url;
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).click(function(e) {
            if (!$(e.target).closest('#vendor_name, #vendorList').length) {
                $('#vendorList').fadeOut();
            }
        });
    });
