<x-default-layout>
    ...
    <h2 class="py-3">Vendor</h2>



    <!-- Accordion Container -->

    @include('pages/vendor.filter')
    ...
    <div class="d-flex justify-content-between align-items-center my-4 px-2">
        ...
        <!-- Add Button -->
        <a class="btn btn-outline-primary btn-sm px-4 new-vendor py-2 shadow-sm fw-semibold text-uppercase d-flex align-items-center gap-2"
            id="add-action" href="{{ route('vendor.add') }}"> <i data-lucide="plus-circle"></i> Add New</a>
    ...
    <div class="listing-grid">
        ...
        <div class="listing-header">
            <div class="checkbox-col">
                <input class="form-check-input vendor_id checkbox-border-color" name="selected" type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" value="" id="flexCheckDefault">
                <span class="d-block d-md-none text-center fw-bold ms-1"> Select All </span>
            </div>

            <div class="col sortable"><i data-lucide="file-text"></i> @sortablelink('vendor_name','Name') </div>
        ...
        <div class="listing-row">
            ...
            <div class="checkbox-col">
                <input class="form-check-input selected checkbox-border-color" name="selected[]" type="checkbox" value="{{ $vendor->vendor_code }}" id="flexCheckDefault">
            ...
            <div class="col"> <span></span> <span>@include('pages/vendor/actions/edit_action') </span> </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.selected, .vendor_id', function() {
            ...
            $('#bulk-invoice-download').on('click', function(e) {
                ...
                form.find('input[name="vendor_ids[]"]').remove(); // clear old values
