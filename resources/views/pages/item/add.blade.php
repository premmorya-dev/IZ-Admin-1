<form action="{{ route('item.store') }}" id="item-form" method="POST" enctype="multipart/form-data">
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-body p-4">
            <div class="row g-4">
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea name="description" id="id_description" class="form-control" placeholder="Item Description" rows="5">{{ old('description') }}</textarea>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <input type="text" name="sku" id="id_sku" value="{{ old('sku') }}" class="form-control" placeholder="SKU">
                </div>
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <input type="number" name="cost_price" id="id_cost_price" value="{{ old('cost_price') }}" class="form-control" placeholder="Purchase Price">
                </div>

                <div class="col-md-6 mt-3">
                    <label class="form-label">Selling Price</label>
                    <input type="number" name="selling_price" id="id_selling_price" value="{{ old('selling_price') }}" class="form-control" placeholder="Selling Price">
                </div>


                <div class="col-md-6 mt-3">
                    <label class="form-label">Type</label>
                    <select id="id_item_type" name="item_type" class="form-select">
        ...
        <div class="card-footer bg-light text-end rounded-bottom-4">
            <button type="submit" class="btn btn-success px-4 w-100 add-item">
