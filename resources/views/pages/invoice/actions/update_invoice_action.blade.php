<div class="dropdown">
    ...
    <div class="dropdown-menu custom-dropdown">
        <a href="#" class="update-invoice" send-status="false"><i data-lucide="save" class="text-primary"></i> Update</a>
        <a href="#" class="update-invoice" send-status="true"><i data-lucide="send" class="text-info"></i> Update & Send Invoice</a>
