      ...
      <div class="card shadow-lg border-0 rounded-4">
          ...
          <div class="card-body p-4 row">
              ...
              <div class="col-md-12 mt-3">
                  ...
                  <input type="text" name="expense_item_name" value="{{ old('expense_item_name', $data['expense_item']->expense_item_name) }}" class="form-control" placeholder="Expense Item Name">
              </div>
              ...
              <div class="col-md-12 mt-3">
                  ...
                  <select name="expense_category_id" class="form-select">
                      ...
                      <option value="{{ $expense_categories->expense_category_id }}" {{ old('expense_category_id', $data['expense_item']->expense_category_id )   == $expense_categories->expense_category_id ? 'selected' : '' }}>{{ $expense_categories->expense_category_name  }}</option>
              ...
              <div class="col-md-6 mt-3">
                  ...
                  <input type="number" name="hsn_sac" value="{{ old('hsn_sac', $data['expense_item']->hsn_sac) }}" class="form-control" placeholder="HSN/SAC">
              </div>

              <div class="col-md-6 mt-3">
                  <label class="form-label">Unit Price</label>
                  <input type="number" name="unit_price" value="{{ old('unit_price', $data['expense_item']->unit_price) }}" class="form-control" placeholder="Unit Price">
              </div>
              ...
              <div class="card-footer bg-light text-end rounded-bottom-4">
                  ...
                  <button type="submit" class="btn btn-success px-4 update-expense-item w-100">
  ...
  <script>
      document.querySelector('.update-expense-item').addEventListener('click', function(e) {
          e.preventDefault();
