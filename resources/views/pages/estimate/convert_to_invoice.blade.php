    ...
    <form action="#" id="invoice-generate" method="POST">
        ...
        <div class="row">
            ...
            <div class="container my-4">
                ...
                <input type="hidden" name="convert_to_invoice" value="1" id="convert_to_invoice">
                <input type="hidden" name="estimate_number" value="{{ $data['estimate']->estimate_number }}" id="convert_to_invoice">
                 <input type="hidden" name="estimate_code" value="{{ $data['estimate']->estimate_code }}" id="convert_to_invoice">
